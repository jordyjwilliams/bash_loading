...
* Store the `bash` script `loading` wherever you want or create an `alias`
* Use away!
...
## Demo Example
[![asciicast](https://asciinema.org/a/531506.svg)](https://asciinema.org/a/531506)
